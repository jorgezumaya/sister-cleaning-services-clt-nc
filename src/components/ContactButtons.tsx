...
/**
 * tel: / sms: / wa.me links each resolve to the right native app per device
 * (phone dialer or Messages on mobile, WhatsApp Web on desktop) without any
 * user-agent sniffing. No email option — quote requests go through the
 * contact form instead, and the business inbox isn't published on the site.
 */
